...
struct imgui_window_t
{
    ...
    glm::dvec2 mouse_wheel;

    bool mouse_pressed[3];
    GLFWcursor* mouse_cursors[ImGuiMouseCursor_Count_] = { 0 };
    ...
    //===================================================================================================================================================================================================================
    // ui related functions to override in the child class
    //===================================================================================================================================================================================================================
    virtual void update_ui() {};
    virtual void set_ui_style();
